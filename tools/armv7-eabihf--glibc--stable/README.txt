armv7-eabihf--glibc--stable-2017.05-toolchains-1-1
...
For those who would like to reproduce the toolchain, you can just follow these steps:
    ...
    curl http://toolchains.free-electrons.com/downloads/releases/build_fragments/armv7-eabihf--glibc--stable-2017.05-toolchains-1-1.defconfig > .config
    make olddefconfig
    make
