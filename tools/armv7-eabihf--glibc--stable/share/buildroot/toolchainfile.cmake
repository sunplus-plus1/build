...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/usr/arm-buildroot-linux-gnueabihf/sysroot")
...
if(0)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/usr/bin/arm-buildroot-linux-gnueabihf-gfortran")
endif()
